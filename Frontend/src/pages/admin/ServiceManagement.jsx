...
const ServiceManagement = () => {
    ...
    const fetchServices = async () => {
        ...
        try {
            ...
            // Note: Check your backend port (8080 or 8081)
    ...
    return (
    <div className="relative flex min-h-screen w-full flex-col group/design-root overflow-x-hidden font-display bg-gray-50 dark:bg-[#1a1a1a]">
        <div className="flex flex-row min-h-screen">

            {/* --- SIDEBAR (Giữ nguyên, chỉ chỉnh nhẹ border) --- */}
            <div className="flex-shrink-0 w-64 bg-white dark:bg-[#222] border-r border-gray-200 dark:border-gray-800 p-4 sticky top-0 h-screen">
                <div className="flex flex-col h-full justify-between">
                    <div className="flex flex-col gap-8">
                        <div className="flex items-center gap-3 px-3 py-2">
                            <div className="bg-center bg-no-repeat aspect-square bg-cover rounded-xl size-10 shadow-sm" style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuC2BtzIqm9StEoELfvqimLJOTrIQSd0Lwia9dzvmfSDhL_22BAC5p0G5w2h6NU8ykSpOOSKaPQCMNsXrEkG5YcDUuyrZM9ktsZ1kl2RrbOv0u1VNYJVNnfnCSmIc9QVh9qQODNALLJdjkKm7GBBhpFg1l7eILy9ZMFEcUXIib4-QyrSKXL2IMNbxqdVX79HpK8ueBtN8552-dFrR2vfm9RinD1Cx4NZBWlfn0vfcABmhDvXHOGgx6GJe8MO4MkF_gpdpYA1WYkWyowI")' }}></div>
                            <div className="flex flex-col">
                                <h1 className="text-gray-900 dark:text-white text-base font-bold leading-normal">Serenity Spa</h1>
                                <p className="text-gray-500 text-xs font-medium">Admin Panel</p>
                            </div>
                        </div>
                        <div className="flex flex-col gap-1">
                            {/* Navigation Links */}
                            <a className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all" href="/admin/dashboard">
                                <p className="text-sm font-medium">Dashboard</p>
                            </a>
                            <a className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-primary/10 text-primary dark:text-primary-400 font-semibold" href="#">
            ...
            {/* --- MAIN CONTENT --- */}
            <main className="flex-1 p-8 overflow-y-auto bg-gray-50 dark:bg-[#121212]">
